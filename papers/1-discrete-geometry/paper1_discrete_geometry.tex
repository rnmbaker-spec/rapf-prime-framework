...
The author acknowledges the use of the Hermes Agent framework for computational assistance, algorithm scripting, and data formatting during the preparation of this manuscript. The validated segmented sieve code, computational results, and LaTeX typesetting were produced with this framework.
