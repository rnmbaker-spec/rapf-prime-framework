...
\vspace{0.5em}
\noindent{\footnotesize CV$_{\rm Poisson} = 100/\sqrt{\mu}$ represents the independent Poisson baseline. Ratio $=$ CV/CV$_{\rm Poisson}$ quantifies sub-Poisson suppression (1.0 = Poisson, $<1.0$ = sub-Poisson). Combined classes = $2 \times A_{n,3}$ (both patterns). Total triplets combines both $\mathcal{H}_1 = (0, 2, 6)$ and $\mathcal{H}_2 = (0, 4, 6)$. Counts strictly reflect prime constellations whose anchor prime $p > p_n$, excluding small local constellations below the primorial modulus baseline. Ranges: $n=3$ covers $[30, 900]$, $n=4$ covers $[210, 44{,}100]$, $n=5$ covers $[2{,}310, 5{,}336{,}100]$, $n=6$ covers $[30{,}030, 9.02 \times 10^8]$, $n=7$ covers $[510{,}510, 2.61 \times 10^{11}]$.
}
\end{table}
