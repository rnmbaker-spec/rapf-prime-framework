...
The fixed-point conjecture suggests a heuristic scaling for the
...
\end{equation}
This idealized model assumes infinite-population Poisson behavior
with no finite-bin constraints. The comparison between this
